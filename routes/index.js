...
module.exports = function(app) {
    ...
    // 获取归档的博文
    app.get('/post/archive', function (req, res) {
    ...
    // 获取某个标签下博文
    app.get('/post/tag/:tag', function (req, res) {
    ...
    // 获取某个用户下的博文
    app.get('/post/user/:name', function (req, res) {
        var page = req.query.p ? parseInt(req.query.p) : 1;
        //检查用户是否存在
    ...
    // 根据id查看某一篇博文
    app.get('/post/view/:_id', function (req, res) {
